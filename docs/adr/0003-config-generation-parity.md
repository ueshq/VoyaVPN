...
- `coregen::context` ports `CoreConfigContextBuilder` behavior, including main/pre-socks contexts, ECH SNI protection, xhttp download address protection, per-rule outbound resolution, and TUN/pre-socks context changes.

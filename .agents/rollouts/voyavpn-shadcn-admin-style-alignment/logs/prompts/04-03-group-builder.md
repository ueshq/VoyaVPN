# Batch 04-03-group-builder: Group Builder Migration
...
## Batch Goal
Migrate group-builder selects, checkboxes, search, badges, cards, and scroll containers to aligned primitives.

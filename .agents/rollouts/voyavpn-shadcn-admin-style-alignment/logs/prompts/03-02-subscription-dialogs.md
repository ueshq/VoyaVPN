# Batch 03-02-subscription-dialogs: Subscription And Import Dialogs
...
## Batch Goal
Migrate subscriptions-dialog and import-profiles-dialog to shared primitives and aligned alert/card/scroll patterns.

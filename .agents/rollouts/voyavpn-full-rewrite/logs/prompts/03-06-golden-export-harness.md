# Batch 03-06-golden-export-harness: Golden Export Harness
...
## Batch Goal
Create the v2rayN golden export path, canonical diff tooling, and optional core acceptance checks.

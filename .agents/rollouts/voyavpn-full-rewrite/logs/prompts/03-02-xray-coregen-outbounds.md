# Batch 03-02-xray-coregen-outbounds: Xray Outbounds And Streams
...
## Batch Goal
Implement Xray outbound generation for protocols, transports, security, mux, proxy chains, policy groups, and finalmask.

# Batch 05-01-routing-settings-editor: Routing Settings And Rule Editor
...
## Batch Goal
Implement routing config CRUD, rule list, rule editor, templates, domain strategies, and reconnect integration.

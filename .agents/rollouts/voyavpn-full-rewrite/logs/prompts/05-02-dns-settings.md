# Batch 05-02-dns-settings: DNS Settings
...
## Batch Goal
Implement simple and per-core advanced DNS settings, custom DNS JSON editors, fakeip controls, and generator integration.

# Batch 03-05-singbox-coregen-routing-dns: Sing-Box Inbounds, Routing, DNS, Rulesets
...
## Batch Goal
Complete sing-box generation for inbounds, typed DNS server schema, routing, fakeip, rulesets, templates, and TUN config.

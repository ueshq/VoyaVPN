# Batch 04-04-system-proxy-tray: System Proxy, PAC, Tray
...
## Batch Goal
Port per-OS system proxy behavior, Windows-only PAC server, proxy mode switching, and dynamic tray menu.

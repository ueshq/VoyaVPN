# Batch 06-04-ruleset-geo: Ruleset And Geo Acquisition
...
## Batch Goal
Implement acquisition, update, validation, and configuration integration for geo dat files and sing-box srs rulesets.

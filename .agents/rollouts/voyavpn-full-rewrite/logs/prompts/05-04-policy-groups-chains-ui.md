# Batch 05-04-policy-groups-chains-ui: Policy Groups And Proxy Chains UI
...
## Batch Goal
Implement policy group and proxy chain builders, child pickers, previews, validation, and generator-backed tests.

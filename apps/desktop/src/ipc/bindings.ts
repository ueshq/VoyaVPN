...
/** Events */
export const events = {
	appEvent: makeEvent<AppChannel>("app-event"),
	invalidateEvent: makeEvent<InvalidateChannel>("invalidate-event"),
	transientStreamEvent: makeEvent<TransientStreamChannel>("transient-stream-event"),
};
